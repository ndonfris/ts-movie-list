...
<html lang="en">
<head>
    <title>Code coverage report for src/genre/getScriptsByGenre.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/genre</a> getScriptsByGenre.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const { removeExtraScripts } = require('./helper/fileSystem');
...
const getScriptsByGenre = async options =&gt; {
	const { genre } = options;
&nbsp;
	<span class="missing-if-branch" title="else path not taken" >E</span>if (isValidGenre(genre)) {
		try {
