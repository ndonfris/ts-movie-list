...
/*  CREATE TABLE movies("id" INTEGER NOT NULL, "Title" TEXT, "Year" TEXT, "Rated" TEXT, "Released" TEXT, "Runtime" TEXT, "Genre" TEXT, "Director" TEXT, "Writer" TEXT, "Actors" TEXT, "Plot" TEXT, "Language" TEXT, "Country" TEXT, "Awards" TEXT, "Poster" TEXT, "Ratings" Text, "Metascore" TEXT, "imdbRating" TEXT, "imdbVotes" TEXT, "imdbID" TEXT, "Type" TEXT, "DVD" TEXT, "BoxOffice" TEXT, "Production" TEXT, "Website" TEXT, "Response" TEXT, PRIMARY KEY("id"));*/
