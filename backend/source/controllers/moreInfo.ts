...
/**
 * @async moreInfo - Callback function to retrieve all availabile info for an imdbID
 *
 * @param req - Json Request data containing the imdbID in the body.Title
 *             {"title": "#xxxxxxx"}
 * @param res - Response this callback generates.
 */
...
/**
 * @async streamingInfo - Callback function to retrieve all availabile streaming platforms for
 *                        an imdbID.
 *
 * @param req - Json Request data containing the imdbID in the body.Title
 *             {"title": "#xxxxxxx"}
